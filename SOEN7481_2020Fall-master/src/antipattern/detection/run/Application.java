...
import core.visitor.common.CatchVisitor;
import core.visitor.common.EqualHashCodeBug;
...
public class Application implements IApplication {
	...
	private void analyze(IPackageFragment mypackage) throws JavaModelException {
		//System.out.println("in analyze proj");
		...
		for (ICompilationUnit unit : mypackage.getCompilationUnits()) {
			...
			CatchVisitor exVisitor = new CatchVisitor(mypackage, unit, parsedUnit);
			parsedUnit.accept(exVisitor);
			EqualHashCodeBug eqhashVisitor = new EqualHashCodeBug(mypackage, unit, parsedUnit);
			parsedUnit.accept(eqhashVisitor);
